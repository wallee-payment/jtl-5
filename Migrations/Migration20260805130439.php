...
{
    protected $description = 'Add cancellation field to the wallee_transactions table';
    ...
    {
        $this->execute("ALTER TABLE `wallee_transactions` DROP COLUMN `cancellation_email_sent`;");
    }
}
