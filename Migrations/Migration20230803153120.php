...
class Migration20230803153120 extends Migration implements IMigration
{
	public function up()
	{
		$this->execute("CREATE TABLE `wallee_refunds` (
		...
		$this->execute("CREATE TABLE `wallee_transactions` (
		    `id` int(11) NOT NULL AUTO_INCREMENT,
	...
	{
		$this->execute('DROP TABLE IF EXISTS `wallee_transactions`');
		$this->execute('DROP TABLE IF EXISTS `wallee_refunds`');
	}
}
